...
class AdamOptimizerTransporter(AbstractTransporter):
    ...
    def serialize(self, data, key, model_type):
        ...
        if (
            (model_type == "MLPRegressor" and key == "_optimizer" and isinstance(data[key], AdamOptimizer)) 
        ):
            optimizer = data[key]
            data[key] = {
                'params': {
    ...
    def deserialize(self, data, key, model_type):
        ...
        return AdamOptimizer(learning_rate=optimizer['learning_rate'], beta_1=optimizer['beta_1'],
                                 beta_2=optimizer['beta_2'], epsilon=optimizer['epsilon'])
