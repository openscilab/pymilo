...
def test_elastic_net_cv():
    ...
    elasticnet_cv_regression = ElasticNetCV(cv= elasticnet_cv, alphas= elasticnet_alphas,random_state= elasticnet_random_state)
    # Train the model using the training sets
    elasticnet_cv_regression.fit(x_train, y_train)
    return test_pymilo_regression(elasticnet_cv_regression, MODEL_NAME, (x_test,y_test))
